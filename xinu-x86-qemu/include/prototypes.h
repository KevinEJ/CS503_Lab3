...
extern	devcall	qrds_control(struct dentry *, int32, int32, int32);
extern	devcall	qrds_init(struct dentry *);
extern	devcall	qrds_open(struct dentry *, char *, char *);
extern	devcall	qrds_read(struct dentry *, char *, int32);
extern	devcall	qrds_write(struct dentry *, char *, int32);
...
extern	devcall	qty_control(struct dentry *, int32, int32, int32);
extern	devcall	qty_getc(struct dentry *);
extern	void	qty_handler(int32);
extern	devcall	qty_init(struct dentry *);
extern	devcall	qty_putc(struct dentry *, char);
extern	devcall	qty_read(struct dentry *, char *, int32);
extern	devcall	qty_write(struct dentry *, char *, int32);
extern	interrupt	qty_dispatch(void);
